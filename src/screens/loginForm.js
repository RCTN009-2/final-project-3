  ...
  return (
    <ScrollView>
      ...
      <View style={{ alignItems: 'center', marginBottom: 8 }}>
        ...
        />
        <Text style={{ fontWeight: 'bold', color: '#1F1E2E', fontSize: 18, marginBottom: 5 }}>
          Log in
        </Text>
      ...
      >
        <Text style={{ color: '#1F1E2E', fontSize: 12, marginBottom: 5 }}>Email</Text>
        <View
          style={{
            flexDirection: 'row',
            borderBottomWidth: 2,
        ...
        <Text style={{ color: '#1F1E2E', fontSize: 12, marginBottom: 5 }}>Password</Text>
        <View
          style={{
            flexDirection: 'row',
            borderBottomWidth: 2,
        ...
        <TouchableOpacity onPress={loginClick}>
          <View style={{ backgroundColor: '#6E6BE8', padding: 15, borderRadius: 10 }}>
